...
const HeroSection = () => {
  return (
    <section className="min-h-screen flex items-center justify-center px-4 bg-valentine relative overflow-hidden">
      ...
      <div className="text-center max-w-2xl relative z-10">
        ...
        <p className="font-body text-xl text-muted-foreground mb-2">
          <BlurText text="Since December 10, 2024" delay={1} />
        </p>
